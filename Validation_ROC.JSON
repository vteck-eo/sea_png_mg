# ==========================================================
# 🌍 Mangrove Probability Validation using ROC Analysis
# ==========================================================
...
# ==========================================================
# 📥 2. Load Validation Dataset (Reference Points)
# ==========================================================
# The CSV contains:
# - lon, lat
...
# ==========================================================
# 🔄 3. Convert DataFrame to Earth Engine FeatureCollection
# ==========================================================
...
# ==========================================================
# 🛰 4. Load Annual Mangrove Probability Assets
# ==========================================================
# Each asset contains a "classification" band (0–100)
# Converted to probability scale (0–1)
...
def load_prob(year):
    return (
        ...
        .divide(100)  # convert to 0–1 probability
        .rename(f"prob_{year}")
    )
...
# ==========================================================
# 📌 5. Sample Probability Values at Validation Points
# ==========================================================
...
# ==========================================================
# 📈 6. Compute ROC Curves (2017–2024)
# ==========================================================
...
plt.title("Mangrove Probability ROC Curves (2017–2024)")
plt.legend()
plt.grid(True)
plt.show()
